...
def scan_device(ip, global_throughput):
    ...
    # Menghitung availability berdasarkan packet_loss dan throughput
    availability = 100 - packet_loss

    # Jika throughput sangat rendah, kita bisa menurunkan availability
    if throughput < 100:  # Misalnya, jika throughput di bawah 100 kbps, availability diturunkan
        availability -= 5
